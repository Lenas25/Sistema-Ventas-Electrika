...
public class DaoClienteImpl implements DaoCliente {
    ...
    public String insert(Cliente categoria) {
        ...
        try (Connection c = con.getConexion()) {
            ...
            mensaje = (ps.executeUpdate() == 0) ? "No se actualizo" : "Se insertó correctamente";
    ...
    public String update(Cliente categoria) {
        ...
        try (Connection c = con.getConexion()) {
            ...
            mensaje = (ps.executeUpdate() == 0) ? "No se actualizó" : "Se actualizó correctamente";
        } catch (Exception e) {
            mensaje = e.getMessage();
        }
        return mensaje;
    ...
    public String delete(Integer id) {
        ...
        try (Connection c = con.getConexion()) {
            PreparedStatement ps = c.prepareStatement(sql.toString());
            ps.setInt(1, id);
            mensaje = (ps.executeUpdate() == 0) ? "No se eliminó" : "Se eliminó";
        } catch (Exception e) {
            mensaje = e.getMessage();
        }
        return mensaje;
