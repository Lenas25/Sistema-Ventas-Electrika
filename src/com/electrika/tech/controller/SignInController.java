...
public class SignInController implements ActionListener {
    ...
    public SignInController(SignInView view) {
        ...
        for (Vendedor ven : lista) {
            DaoVendedorImpl.empleado.put(ven.getCodUsuario(), ven);
        }
    }
    ...
    private void iniciar() {
        ...
        if (bool1) {
            ...
            Vendedor empl = new Vendedor(null, capitalizeFirstLetter(view.txtNewApellido.getText()), capitalizeFirstLetter(view.txtNewNombre.getText()), view.txtNewUsuario.getText(), view.txtNewContra.getText(), "Vendedor", "2020-03-25", "2020-03-25");
            String mensaje = dao.insert(empl);
            if (Objects.equals(mensaje, "El usuario ya existe")) {
                JOptionPane.showMessageDialog(null, mensaje);
                view.txtNewNombre.setText(null);
                view.txtNewApellido.setText(null);
                view.txtNewContra.setText(null);
                view.txtNewUsuario.setText(null);
            } else{
                JOptionPane.showMessageDialog(null, mensaje);
                //Bienvenido               
                HomeView prin = new HomeView();
                HomeViewController homc = new HomeViewController(prin, empl);
                view.dispose();
            }
        }
    }
